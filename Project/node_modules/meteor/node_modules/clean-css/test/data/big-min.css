...
.grid_16,
.grid_17,
.grid_18{box-sizing:border-box;-moz-box-sizing:border-box;-webkit-box-sizing:border-box;display:inline;float:left;position:relative;margin-left:8px;margin-right:8px}
...
section article{margin:0 0 16px 0}
...
.croix_blanche,.croix_grise,.nl_blanc{background:url(/medias/web/img/sprites/icos_petites.png) no-repeat;display:inline-block;text-indent:-9999px;height:13px;width:13px;cursor:pointer}
...
.titre_une{margin:0 0 10px 0}
.titre_une figcaption{margin:5px 0 0 0}
...
.global.debats .nature_edito{margin:0 0 5px 0}
.global.debats .tt17_capital{margin:0 0 16px;padding:4px 0 4px;border-bottom:1px solid #e9edf0;color:#000}
...
.haut_rubrique{margin:0 0 20px;border-bottom:6px solid #e9edf0;padding:0 0 4px 0}
...
.fleuve .atome{margin:0 0 10px 0}
...
.toute-l-actualite h3{display:inline;font-size:11px;font-weight:400}
...
#footer_services .contenu_bloc,#footer_services .img_bloc{height:142px;padding:5px 16px 5px;border:solid #e4e6e9;border-width:0 1px 1px;background:#fafbfc}
...
#footer_services .conteneur_liste_tv{height:150px;border:solid #eef1f5;border-width:0 1px 1px 1px}
...
#footer .footer_listes .titre{display:block;margin:0 0 4px 0;font-weight:700;color:#eef1f5}
...
.sociaux .obf:hover strong,.sociaux .obf:hover span,.sociaux .obf:focus strong,.sociaux .obf:focus span{color:#000;text-decoration:none}
...
#header_utilisateur .meteo a{margin:0 15px 0 0;padding:0 0 3px 0;color:#747b83}
...
.lightbox_ext .intitule,.loginbox .intitule{margin:0 0 15px 0;font-size:18px;line-height:18px;color:#000;font-weight:700}
...
.reaction_identifier .deja_abo .txt18{display:inline-block;margin:0 0 15px 0}
...
.conteneur_barre_outils .reaction_identifier{margin:0 0 20px 0;border-bottom:3px solid #e9ecf0;border-top:0}
...
.bloc_part .accroche{display:block;margin:0 0 8px 0}
...
.bloc_part.empruntis .contenu{padding:0 15px 0;background:url(/medias/web/img/partenaires/empruntis/stylo.jpg) no-repeat}
...
.bloc_part .homelidays{padding:0 0 0}
...
.col_droite .plus_partages .bulle_nombre,.col_droite .plus_partages .numero{margin:2px 0 0 0;text-align:center}
...
.conteneur_lives .lives .chrome .live_deplier,.conteneur_lives .lives .chrome .live_fermer{background-image:url(/medias/web/img/sprites/icos_live.png)}
...
.conteneur_lives .lives.grand .chrome .live_deplier,.conteneur_lives .lives.grand .chrome .live_fermer{opacity:.6}
.conteneur_lives .lives.grand .chrome .live_replier:hover,.conteneur_lives .lives.grand .chrome .popup:hover,
.conteneur_lives .lives.grand .chrome .live_deplier:hover,.conteneur_lives .lives.grand .chrome .live_fermer:hover{opacity:1}
...
.conteneur_alerte .sociaux .txt11{display:block;margin:0 0 10px 0;color:#5d666d;font-weight:700}
...
#header-liberation .header-base .digitalpaper{display:block;float:left}
...
ul.errorlist{background:#fafafa;border:1px solid #e20000;color:#2e2e2e;margin:0 0 5px 0;padding:5px}
...
.block.rounded,
.block .block-content.rounded{border-radius:5px;-moz-border-radius:5px;-webkit-border-radius:5px}
...
#core-liberation .block-basic-curled .shadow-top-right{display:block;position:absolute;z-index:0;width:35%;max-width:100%;max-height:100%}
#core-liberation .block-basic-curled .shadow-left,
...
#core-liberation .block-basic-curled .block-content{position:relative;z-index:1000;background:#fff}
...
#core-liberation .cartridge-basic-bubble .segment{display:block;float:left;border:1px solid #222;border-radius:5px;-moz-border-radius:5px;-webkit-border-radius:5px}
...
#core-liberation .pagination .current{background:#7d7d7d;color:#fff}
...
#core-liberation,
#header-liberation,
#footer-liberation{display:block;clear:both;margin:0 0 14px 0}
#core-liberation{padding:0 10px}
#header-liberation{padding:0}
#footer{margin-bottom:0;padding:0 0 28px 0}
...
ul.list li.new-line{clear:both;margin-left:0}
...
.ad-google .googleBanner .annonce{margin:0 0 7px 0;padding:7px;font-size:12px;border:1px solid}
...
#header-liberation .header-base .digitalpaper a.abo{display:block;position:absolute;top:15px;right:0;width:79px;height:34px;padding-left:10px;padding-top:7px;font-size:11px;font-family:Arial,Verdana,sans-serif}
...
#header-liberation .header-base .nav .nav1 a:hover span{width:9px;height:9px}
...
#header-liberation .header-annex{position:relative;margin:0 42px;padding:20px 0 0 0}
...
#header-liberation .header-annex ul{display:block;margin-left:230px}
#header-liberation .header-annex h1{border-bottom:1px solid;height:25px;margin-top:10px;padding:0 0 5px 0;text-align:right;font-size:18px;text-transform:uppercase;font-weight:400}
...
#footer-liberation .services{display:block;float:left}
...
#footer-liberation .services h5{text-transform:uppercase;padding:0 0 4px 0;font-size:10px}
...
#footer-liberation .services ul{border-right:1px dotted;font-size:10px;width:83px;float:left;min-height:150px}
#footer-liberation .news ul:last-of-type,
#footer-liberation .services ul:last-of-type{border-right:0;width:84px}
#footer-liberation .news ul li,
#footer-liberation .services ul li{padding:0 14px 0 0;margin-bottom:7px;line-height:10px}
...
#core-liberation .text-https h4{font-family:Verdana,sans-serif;font-weight:400}
...
form input[type=password]{border:1px solid;padding:3px;height:14px}
...
#core-liberation .error_ajax_form{background:#ddd;border:1px solid #9d9d9d;padding:10px 10px 12px}
...
#core-liberation .form-monlibe textarea{border:1px solid;font-size:12px;margin-bottom:20px;padding:3px}
...
#core-liberation .form-https p input[type=password]{display:block;width:372px;border-radius:2px;-moz-border-radius:2px;-webkit-border-radius:2px;-o-border-radius:2px;margin-bottom:14px;padding:7px}
#core-liberation .form-https .btn-rounded-degraded,
#core-liberation .form-https .btn-laune{margin-top:7px;float:right}
...
#core-liberation ul.list-items li img.signature{width:84px;height:84px}
...
#core-liberation ul.list-labo-meetings li:last-child p{margin-bottom:0;padding-bottom:0}
...
.col-contextual>.first{margin-top:0;margin-bottom:0}
...
.col-contextual .block-ad{display:block;margin:14px auto;width:300px}
...
.col-part .block .block-top{text-transform:uppercase;font-weight:700;padding:7px 0 7px;text-align:center}
...
.col-part .block .follow-libe .nv-rss a.rss{display:inline-block;height:18px;padding:2px 0 0 23px}
...
#core-liberation .block-comments .comment_level_0{margin-top:20px;border-top:1px solid}
...
#core-liberation .block-comments .comment_level_0>.comment_outer{margin-left:-1px;border:1px solid;border-top:0}
...
#core-liberation .block-comments .block-content .comment_reply_links{padding:14px 0 0 0;height:30px}
#core-liberation .block-comments .block-content .comment_reply_links .comment_flag,
#core-liberation .block-comments .block-content .comment_reply_links .comment_post_new{display:none;float:right;margin-right:10px;padding-top:5px}
...
#core-liberation .block-comments .block-content .comment_reply_links .comment_reply{display:none;float:right;padding:5px 10px 7px;border-radius:5px 5px 5px 5px;-moz-border-radius:5px 5px 5px 5px;-webkit-border-radius:5px 5px 5px 5px}
...
#core-liberation .block-comments .headrest-community a.unfolded:after{display:inline-block;content:'';background-image:url(http://s0.libe.com/libe/img/common/_sprites_icons/icons.png?9914d0d70a49);background-repeat:no-repeat}
...
#core-liberation .block-partnership .block-content a.arrow{background:url(http://s0.libe.com/libe/img/common/ico-lnk-arrow-red.gif?feba6ff926a7) no-repeat 0 4px;padding-left:15px}
